 ...
 */
package com.ahmedtikiwa.sunshine.app.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("testInsertReadDb weatherEntry failed to validate", cursor, contentValues);
    ...
    public long insertLocation() {
        ...
        // Move the cursor to a valid database row
        assertTrue("Error: There were no rows returned in the location query", cursor.moveToFirst());
